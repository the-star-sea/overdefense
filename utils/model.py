...
class GPT:
    def __init__(self, model_name, api="sk-nRjm3MuSfJ9yoDZu987f9f8c0b014052B463046c0587B01c", temperature=0, seed=0):
        self.model_name = model_name
        self.client = OpenAI(
            api_key=api,
        )
        self.client.base_url="https://api.ai-gaochao.cn/v1"
        self.T = temperature
        self.seed=seed
